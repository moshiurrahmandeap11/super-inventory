...
const Sidebar = ({ isOpen, selectedItem, onItemSelect }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      submenu: [
        { id: 'sales-report', label: 'Sales Report', path: '/inventory/reports/sales' },
        { id: 'stock-report', label: 'Stock Report', path: '/inventory/reports/stock' },
        { id: 'profit-loss', label: 'Profit & Loss', path: '/inventory/reports/profit-loss' }
      ]
    },
    {
      id: 'settings',
    ...
    <>
      ...
      `}>
        ...
        <div className="h-full flex flex-col">
          ...
          <div className={`p-4 border-b border-gray-200 ${!isOpen && 'lg:hidden'}`}>
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-linear-to-r from-blue-500 to-indigo-600 rounded-full flex items-center justify-center">
                <span className="text-white font-semibold text-lg">
                  {localStorage.getItem('user')?.charAt(0)?.toUpperCase() || 'I'}
                </span>
              </div>
            ...
            <div className="space-y-1">
              {menuItems.map((item) => (
                <div key={item.id}>
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <span className={`${isItemActive(item) ? 'text-blue-600' : 'text-gray-500'}`}>
                        {item.icon}
                      </span>
                  ...
                  {item.submenu && expandedMenu === item.id && (
                    <div className={`mt-1 ml-2 pl-8 space-y-1 ${!isOpen && 'lg:hidden'}`}>
          ...
          {/* Sidebar Footer */}
          <div className={`p-4 border-t border-gray-200 ${!isOpen && 'lg:hidden'}`}>
