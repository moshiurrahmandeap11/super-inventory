...
import { FiAlertTriangle, FiCalendar, FiDollarSign, FiGrid, FiPackage, FiTrendingUp, FiXCircle } from "react-icons/fi";
...
const InventoryHome = () => {
    ...
    const [recentActivities, setRecentActivities] = useState([
        { id: 1, type: "sale", item: "Laptop", quantity: 2, time: "2 hours ago", amount: "$2400" },
        { id: 2, type: "purchase", item: "Smartphone", quantity: 50, time: "5 hours ago", amount: "$25,000" },
        { id: 3, type: "low_stock", item: "Mouse", quantity: 5, time: "1 day ago", amount: "" },
        { id: 4, type: "sale", item: "Monitor", quantity: 3, time: "2 days ago", amount: "$900" },
    ]);

    const [topProducts, setTopProducts] = useState([
        { id: 1, name: "Gaming Laptop", category: "Electronics", stock: 15, sales: 245 },
        { id: 2, name: "Wireless Mouse", category: "Accessories", stock: 120, sales: 189 },
        { id: 3, name: "USB-C Cable", category: "Accessories", stock: 200, sales: 156 },
        { id: 4, name: "Mechanical Keyboard", category: "Electronics", stock: 25, sales: 98 },
    ]);
    ...
    const getActivityIcon = (type) => {
        switch(type) {
            ...
            case 'purchase': return <FiPackage className="text-blue-500" />;
            case 'low_stock': return <FiAlertTriangle className="text-yellow-500" />;
            default: return <FaRegChartBar className="text-gray-500" />;
        }
    };
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-4 md:p-6 lg:p-8">
            ...
            <div className="mb-6 md:mb-8">
                ...
                <p className="text-gray-600 mt-2">Manage and monitor your inventory efficiently</p>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4">
                    ...
                    <div className="bg-white p-3 rounded-lg shadow-sm border border-gray-200">
                        ...
                        <p className="text-lg font-semibold text-red-600">18 Items</p>
                    </div>
                    <div className="bg-white p-3 rounded-lg shadow-sm border border-gray-200">
                        <p className="text-xs text-gray-500">Stock Value</p>
                        <p className="text-lg font-semibold text-green-600">$124.5K</p>
                    </div>
                </div>
            </div>
                                ...
                                <div className="p-5 md:p-6">
                                    <div className="flex items-center justify-between mb-4">
                                        <div className={`p-3 rounded-lg bg-gradient-to-br ${item.color} bg-opacity-10`}>
                                            <div className={`${item.color.split(' ')[0].replace('from-', 'text-')}`}>
                                                {item.icon}
                                            </div>
                                        </div>
                                        <div className="text-right">
                                            ...
                                            <div className="flex items-center justify-end mt-1">
                                                ...
                                                <FaArrowRight className="ml-2 text-gray-400 group-hover:translate-x-1 transition-transform" size={12} />
                                            </div>
                                        </div>
                                    </div>
                                    <h3 className="text-lg font-semibold text-gray-900 mb-1">{item.label}</h3>
                                    <p className="text-sm text-gray-500">Click to view detailed information</p>
            ...
            <div className="mt-6 md:mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
                ...
                <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-5 md:p-6">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <Link href="/activities" className="text-sm text-blue-600 hover:text-blue-800 font-medium flex items-center">
                            View All
                                    ...
                                    <div className="flex items-center mt-1">
                                        <span className={`text-xs px-2 py-1 rounded-full ${
                                            ...
                                            {activity.type === 'sale' ? 'Sale' : 
                                             activity.type === 'purchase' ? 'Purchase' : 'Low Stock'}
                                        </span>
                ...
                <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-5 md:p-6">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <Link href="/products" className="text-sm text-blue-600 hover:text-blue-800 font-medium flex items-center">
                            View All
                            <FaArrowRight className="ml-1" size={14} />
                        </Link>
                    </div>
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center justify-between mt-1">
                                        ...
                                        <div className="flex items-center space-x-4">
                                            ...
                                            <span className="text-xs font-semibold text-blue-600">Sales: {product.sales}</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="ml-4">
            ...
            <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 flex justify-around">
                ...
                <Link href="/reports" className="flex flex-col items-center text-gray-500">
